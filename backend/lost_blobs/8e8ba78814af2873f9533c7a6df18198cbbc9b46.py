...
class TeacherCourseUseCases {
  ...
  Future<LessonBlock> createLessonBlock(String courseId, String lessonId, Map<String, dynamic> data) => _repository.createLessonBlock(courseId, lessonId, data);
  Future<List<LessonBlock>> listLessonBlocks(String courseId, String lessonId) => _repository.listLessonBlocks(courseId, lessonId);
  Future<LessonBlock> updateLessonBlock(String courseId, String lessonId, String blockId, Map<String, dynamic> data) => _repository.updateLessonBlock(courseId, lessonId, blockId, data);
  Future<LessonBlock> duplicateLessonBlock(String courseId, String lessonId, String blockId) => _repository.duplicateLessonBlock(courseId, lessonId, blockId);
  Future<void> deleteLessonBlock(String courseId, String lessonId, String blockId) => _repository.deleteLessonBlock(courseId, lessonId, blockId);
}
