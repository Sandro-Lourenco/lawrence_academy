...
VALUES 
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'Curso A', 'curso-a', 'modelagem', 'iniciante', 'Resumo A', 'published'),
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'Curso B', 'curso-b', 'costura', 'iniciante', 'Resumo B', 'published');

INSERT INTO public.modules (id, course_id, title, order_index)
VALUES 
    ('m1m1m1m1-m1m1-m1m1-m1m1-m1m1m1m1m1m1', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Módulo 1 Curso A', 1);

INSERT INTO public.lessons (id, module_id, course_id, title, status, hls_storage_path, is_preview)
VALUES 
    ('l1l1l1l1-l1l1-l1l1-l1l1-l1l1l1l1l1l1', 'm1m1m1m1-m1m1-m1m1-m1m1-m1m1m1m1m1m1', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Lição Premium', 'published', 'lessons/l1/master.m3u8', false),
    ('l2l2l2l2-l2l2-l2l2-l2l2-l2l2l2l2l2l2', 'm1m1m1m1-m1m1-m1m1-m1m1-m1m1m1m1m1m1', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Lição Preview', 'published', 'lessons/l2/master.m3u8', true);
...
BEGIN
    ...
    SET LOCAL role = 'anon';
    SELECT COUNT(*) INTO v_count FROM public.modules WHERE id = 'm1m1m1m1-m1m1-m1m1-m1m1-m1m1m1m1m1m1';
    IF v_count = 0 THEN RAISE EXCEPTION 'FAIL: Anon could not read module'; END IF;

    SELECT COUNT(*) INTO v_count FROM public.lessons WHERE id = 'l1l1l1l1-l1l1-l1l1-l1l1-l1l1l1l1l1l1';
    IF v_count <> 0 THEN RAISE EXCEPTION 'FAIL: Anon could read premium lesson'; END IF;

    SELECT COUNT(*) INTO v_count FROM public.lessons WHERE id = 'l2l2l2l2-l2l2-l2l2-l2l2-l2l2l2l2l2l2';
