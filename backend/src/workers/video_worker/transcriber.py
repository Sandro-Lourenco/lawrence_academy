    ...
    for seg in segments:
        ...
        if cleaned and seg["start"] < cleaned[-1]["end"]:
            ...
            if similarity > 0.5:
                ...
                for t in t2_list:
                    if (
                        t not in merged_tokens[-3:]
                    ):  # evita repetição de palavras no final
                        merged_tokens.append(t)
    ...
    return [
        {
            "start": 0.0,
            "end": 4.5,
            "text": "Olá a todos! Sejam muito bem-vindos à Lawrence Academy.",
        },
        {
            "start": 5.0,
            "end": 9.2,
            "text": "Hoje vamos aprender sobre a construção da pense de busto em alfaiataria feminina.",
        },
        {
            "start": 10.0,
            "end": 14.5,
            "text": "O primeiro passo é posicionar a fita métrica a partir do ombro para localizar o ápice anatômico.",
        },
        {
            "start": 15.0,
            "end": 19.8,
            "text": "Marque o centro com uma caneta de ponta fina, tomando muito cuidado para manter o alinhamento.",
        },
        {
            "start": 20.5,
            "end": 26.0,
            "text": "Em seguida, faremos a transferência de pense abrindo a lateral e fechando a cintura no molde base.",
        },
        {
            "start": 27.2,
            "end": 32.5,
            "text": "Lembre-se de manter uma folga de costura de 1.5 cm nas bordas do decote.",
        },
        {
            "start": 33.0,
            "end": 37.8,
            "text": "Isso garante que o acabamento em viés na seda tenha elasticidade visual sem repuxar.",
        },
    ]
