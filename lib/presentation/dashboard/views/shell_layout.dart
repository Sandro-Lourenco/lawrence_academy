...
import 'package:lawrence/shared/widgets/liquid_glass_sidebar.dart';
...
class ShellLayout extends StatelessWidget {
  ...
  int _getSelectedIndex(String path) {
    ...
    if (path.startsWith('/lives')) return 2;
  ...
  void _onBottomNavTapped(BuildContext context, int index) {
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
        context.go('/courses'); // Placeholder para Lives
        break;
      case 3:
        context.go('/admin/analytics'); // Placeholder para Atividades
        break;
      case 4:
        context.go('/admin/analytics'); // Placeholder para Perfil
        break;
    }
  }
}
