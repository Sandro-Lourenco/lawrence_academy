...
class _CoursePlayerPageState extends ConsumerState<CoursePlayerPage>
  ...
  bool _isPlayingVideo =
      false; // Controla se o player de vídeo está ativo no topo
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Procurando dispositivos para transmissão...',
                          ),
                        ),
                      );
                    },
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            LiquidGlassCard(
                              ...
                              borderColor: LawrenceTheme.primary.withOpacity(
                                0.08,
                              ),
                              padding: const EdgeInsets.symmetric(
                                horizontal: 20.0,
                            ...
                            LiquidGlassCard(
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Iniciando download offline seguro encryptado...',
                                    ),
                                  ),
                                );
                              },
                            ...
                            LiquidGlassCard(
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Turma adicionada ao seu plano de estudos.',
                                    ),
                                  ),
                                );
                              },
                        ...
                        children: [
                          ...
                          _buildQuickAction(
                            ...
                            onTap: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Aula concluída! Parabéns!'),
                                ),
                              );
                            },
                          ),
                          _buildQuickAction(
                            ...
                            onTap: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Abrindo dúvidas e fórum da turma...',
                                  ),
                                ),
                              );
                            },
                          ...
                          _buildQuickAction(
                            ...
                            onTap: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Limpando cache offline desta aula.',
                                  ),
                                ),
                              );
                            },
                    ...
                    return Padding(
                      ...
                      child: LiquidGlassCard(
                        ...
                        borderColor: isActive
                            ? LawrenceTheme.primary.withOpacity(0.2)
                            : null,
                        child: Row(
                          children: [
                            Icon(
